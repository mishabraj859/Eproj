...
<font face="Maiandra GD">
	<title>kAFASHION</title> <spring:url value="/resources/css" var="css" />
	<spring:url value="/resources/js" var="js" /> <spring:url
		value="/resources/pics" var="pics" />
	...
	<link rel="stylesheet" href="${css}/bootstrap.min.css"> <script
		...
		src="${js}/jquery2.min.js"></script> <script
...
@media ( min-width : 800px) .modal-lg {
	width
	:
...
<body>
	...
	<div class="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			...
			<%-- 		<img src="${pics}\ash.jpg" style="width:20px">kA FASHION --%>
			<!-- 	  </a> -->
			<!--     </div> -->

			<div class="navbar-header">
				<a class="navbar-brand" href="#"> <span><img
						src="${pics}\ash.jpg" style="width: 20px"></span> kA FASHION
				</a>
			</div>

			<ul class="nav navbar-nav">
				<li><a href="<c:url value='/'/>"><i class="fa fa-home"
						aria-hidden="true"></i> Home</a></li>
<%-- 						<li><c:url var="allproduct" value="/viewpro"/><a href="${allproduct}"><i class="fa fa-home" --%>
<!-- 						aria-hidden="true"></i> AllProduct</a></li> -->

				<li><a href="<c:url value='/contact'/>"><i class="fa fa-phone" aria-hidden="true"></i> Contact Us</a></li>
				<li><a href="<c:url value='/about'/>"><i class="fa fa-info"  aria-hidden="true"></i> About</a></li>
			</ul>
...
<%-- 	                        <li><a href="<c:url value='/EditUser'/>"> --%>
<!-- 	                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit User</a></li> -->
						</security:authorize>
					</c:if>
					<li></li>
					<li><a href="<c:url value='/like'/>"><i
							class="fa fa-heart" aria-hidden="true"></i> LiKE iT TAKE iT <span class="badge">${items}</span></a></li>
					<li><a href="<c:url value='/order'/>"><i
							class="fa fa-truck" aria-hidden="true"></i> Your Orders</a></li>
					<li><a href="<c:url value='/viewpro'/>"> <i
							class="fa fa-product-hunt" aria-hidden="true"></i> Products
							Available
					</a></li>
				</ul>
			</div>
