          ...
          <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <hr>
									<div>
                                       <center> <img src="${pics}/${product.getPid()}.jpg" > </center>
                                     </div>
                                </div>
                                <!--/.First column-->
                                ...
                                <div class="col-md-6">
                                   ...
                                   <center> <h2>Product Details</h2></center>
									...
									<h3 class="card-title"><font color="black"> 
					              	<a style="color:black;">${product.getPname()}</a></font>
					                </h3>
                                    <!--Price-->
                                    <div class="price">
                                        <p><font color="BLACK" size="5"><span class="price-after"><i class="fa fa-inr" aria-hidden="true"></i> ${product.getPcost()}</span></font> 
									...
									<button type="submit" class="btn btn-default" data-dismiss="modal">
									 <a href="<c:url value="/addToCart/${product.getPid()}"/>" title="Add to likelist">
