<%@include file="header.jsp"%>
  ...
  <c:url value='/addsup' var="add" />
      ...
      <form:input type="hidden" class="form-control" path="sid" id="s_id" placeholder="Enter s_id"/>
					...
					<tbody>
						...
						<c:forEach items="${lists}" var="s1">
							<tr>
								...
								<td>
									<a href="<c:url value='/deletesupplier/${s1.getSid()}'/>"  style="width: 35px"
										" data-toggle="tooltip" data-placement="top"
										title="Remove item">
										<i class="fa fa-trash-o" aria-hidden="true"></i>
									</a>
									<a href="<c:url value='/edditsupplier/${s1.getSid()}'/>"  style="width: 35px"
										" data-toggle="tooltip" data-placement="top"
										title="Remove item">
